...
const sap_routes_1 = __importDefault(require("./modules/sap/sap.routes"));
const calendar_routes_1 = __importDefault(require("./modules/calendar/calendar.routes"));
const innovation_routes_1 = __importDefault(require("./modules/innovation/innovation.routes"));
const tech_radar_routes_1 = __importDefault(require("./modules/tech-radar/tech-radar.routes"));
const email_analytics_routes_1 = __importDefault(require("./modules/email-analytics/email-analytics.routes"));
...
app.use('/api/v1/sap', sap_routes_1.default);
app.use('/api/v1/calendar', calendar_routes_1.default);
app.use('/api/v1/innovation', innovation_routes_1.default);
app.use('/api/v1/tech-radar', tech_radar_routes_1.default);
app.use('/api/v1/email', email_analytics_routes_1.default);
